...
import {
  ...
  getBatchEstimatesFromEastMoney,
} from "../services/fundEstimate.js";
import {
  getFundHistoryFromEastMoney,
  getTradingDaysFromEastMoney,
} from "../services/fundHistory.js";
...
router.get("/trading-days", async (req, res) => {
  try {
    ...
    const days = await getTradingDaysFromEastMoney(
      startDate as string,
      endDate as string,
    );
